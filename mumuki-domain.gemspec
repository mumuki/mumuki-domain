...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'mumukit-auth', '~> 7.14'
  ...
  s.add_dependency 'mumukit-platform', '~> 7.1'
  s.add_dependency 'mumukit-sync', '~> 1.0'
  s.add_dependency 'mumukit-login', '~> 7.9'
  ...
  s.add_development_dependency 'faraday-retry', '~> 2.0'
