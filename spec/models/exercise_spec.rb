...
describe Exercise do
  ...
  describe '#extra' do
    context 'when exercise has no extra code' do
      it { expect(exercise.extra).to be nil }
      it { expect(exercise.accumulated_extra).to eq '' }
    end
    ...
    context 'when exercise has extra code and has no guide' do
      ...
      it { expect(exercise_with_extra.accumulated_extra).to eq "exercise extra code\n" }
    end
    ...
    context 'when exercise has extra code and belongs to a guide with extra code' do
      ...
      it { expect(exercise_with_extra.extra).to eq 'exercise extra code' }
      it { expect(exercise_with_extra.accumulated_extra).to eq "guide extra code\nexercise extra code\n" }
    end
  end
