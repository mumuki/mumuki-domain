class User < ApplicationRecord
  ...
  def detach!(role, course, make_ex_student = true)
    make_ex_student_of! course.slug if make_ex_student && student_of?(course.slug) && solved_any_exercises?(course.organization)
